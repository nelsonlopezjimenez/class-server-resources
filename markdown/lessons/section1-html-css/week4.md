...
- Properly set up a form
- Understand how to properly structure a table.
- Properly use HTML tools to help debug and write clean code
- Use the DOM Inspector and DevTools

## Day 1: Working with Forms

### Mandatory Reading:

- [How Do Forms, Labels, and Inputs Work in HTML?](http://localhost:8001/learn/responsive-web-design-v9/lecture-working-with-forms/how-do-forms-labels-and-inputs-work-in-html)
- [What Are the Different Types of Buttons, and When Should You Use Them?](http://localhost:8001/learn/responsive-web-design-v9/lecture-working-with-forms/what-are-the-different-types-of-buttons)
- [What Is Client-Side Form Validation in HTML Forms, and What Are Some Examples?](http://localhost:8001/learn/responsive-web-design-v9/lecture-working-with-forms/what-is-client-side-form-validation-in-html-forms)
- [What Are the Different Form States, and Why Are They Important?](http://localhost:8001/learn/responsive-web-design-v9/lecture-working-with-forms/what-are-the-different-form-states)

### Optional Readings:

[MDN - Forms](http://localhost:22022/websites/developer.mozilla.org/en-US/docs/Learn/Forms.html) - Work through the guides listed here
[w3Schools - Forms](http://localhost:22022/websites/w3schools.com/html/html_forms.html)
[w3Schools - Form Attributes](http://localhost:22022/websites/w3schools.com/html/html_forms_attributes.html)
[w3Schools - Form Elements](http://localhost:22022/websites/w3schools.com/html/html_form_elements.html)
[w3Schools - Inputs](http://localhost:22022/websites/w3schools.com/html/html_form_input_types.html)
[w3Schools - Input Attributes](http://localhost:22022/websites/w3schools.com/html/html_form_attributes.html)
...
- [What Are HTML Tables Used For, and What Should They Not Be Used For?](http://localhost:8001/learn/responsive-web-design-v9/lecture-working-with-tables/what-are-html-tables-used-for)

### Optional Readings:

- [MDN - Tables](http://localhost:22022/websites/developer.mozilla.org/en-US/docs/Learn/HTML/Tables/Basics.html)
- [MDN - Table Features](http://localhost:22022/websites/developer.mozilla.org/en-US/docs/Learn/HTML/Tables/Advanced.html)
- [w3Schools - Tables](http://localhost:22022/websites/w3schools.com/html/html_tables.html) - Work through the 8 pages
