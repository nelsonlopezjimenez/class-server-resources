...
7.  Server-Side vs. Client-Side Applications
8.  Annotating Your Code with Comments
9.  Expanding the Role of JavaScript
...
[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#introduction-to-javascript-syllabus-some-history)
...
[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#to-be-successful-in-this-class-you-should-plan-to)

1.  Arrive on time and prepared for class
2.  Take an active role in your own learning and understanding of the material
3.  Commit twelve hours a week to homework and assignments outside of class.
4.  Let me know if material is not clear or when its relevance to the student learning outcomes for the course is not apparent (or when you’re bored out of your mind!).
5.  It is also expected that you will treat classmates with respect, avoiding gratuitous arguments,
6.  I expect you to take the opportunity to learn from your peers through activities in lecture and section, and I expect you to be respectful and courteous to one another. Finally, I expect you to hold yourself to the highest standards for academic honesty and integrity in your work.

## Course Syllabus

[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#course-syllabus)

Read the [Course Syllabus](https://canvas.corrections.sbctc.edu/courses/392419000000591/pages/syllabus-q2-april-2026 "Syllabus Q2 April 2026") and [course structure](https://canvas.corrections.sbctc.edu/courses/392419000000591/pages/course-structure-section-two "course-structure-section-two") to see daily, weekly, grading and lab/assignment expectations.

## Keys to learning Javascript:

[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#keys-to-learning-javascript)

Javascript can be overwhelming to new students. Here are some keys to help you get the most out of this section:

-   **Practice, Practice, Practice:** Throughout this section the key to learning JavaScript is consistent practice. Don't just do the assignment; you should experiment, try different approaches, and build small projects on your own.
-   **Debugging:** Learn to use your browser's developer tools (Console, Elements) to debug your code. This is a crucial skill and can help save many hours of headache tracking down bugs.
-   **Double Check Spelling and Casing:** Many issues are due to typing errors. myName and myname are two different variables, and console.log() doesn't exist with in javascript. VSCode will help you catch some of these bugs but not all. Carefully and patiently review your code if you have errors.
...
[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#class-information)

### Assignment/Labs Expectations:

[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#assignmentlabs-expectations)
...
[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#javascript)
...
[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#main-characteristics)
...
-   **dynamically typed**: equal to reassigning a variable (one type into another) -**loosely typed**: do not enforce a type which typescript does -**interpreted**: it does not need compilation step before program can run. In reality it happens but it is called Just In Time compilation
...
[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#a-bit-of-history)
...
[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#common-programming-concepts)
...
[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#javascript-versions)

1.  The current version is ES2025. The official name of the standard is ECMAScript.
2.  The first ECMAScript versions were abbreviated by numbers: ES1, ES2, ES3, ES5, ES6
3.  From 2016, versions are named by year
4.  Ref [JavaScript versions in W3S](https://www.w3schools.com/js/js_versions.asp)

### Technologies based on JavaScript

[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#technologies-based-on-javascript)

#### Frontend

[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#frontend)
...
Full frontend framework (Google)
...
HTML extensions, minimal JS

#### Backend

[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#backend)
...
JS runtime on the server

**Deno**

Secure Node alternative (Ryan Dahl)
...
Lightweight, edge-ready framework
...
[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#mobile)
...
[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#desktop)
...
Lighter Electron alternative (Rust core)

#### Full Stack / Meta-frameworks

[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#full-stack--meta-frameworks)
...
Content-focused, multi-framework
...
[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#tooling)
...
Extremely fast bundler/minifier
...
[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#superset-languages)
...
Typed JavaScript (Microsoft)

**JSX/TSX**

JS with embedded HTML syntax

#### Database / Data

[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#database--data)
...
Modern ORM for Node/TypeScript

**GraphQL (Apollo)**

Query language, heavy JS ecosystem

#### Edge / Serverless

[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#edge--serverless)
...
[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#serverclient-side-apps)
...
[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#comments)
...
> Bad comment: `i++ // increment i` Good comment: `i += 2 // skip header row, data starts at index 1`

### Expanding the role of JS

[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#expanding-the-role-of-js)
...
Servers. JS leaves the browser

2012–15

Mobile (React Native), desktop (Electron)

2017+

IoT, robotics (Johnny-Five), edge computing

2020+

ML in-browser (TensorFlow.js), WebAssembly companion

Now

AI tooling, CLI apps, serverless functions, game engines
...
[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#git-and-gitea)
...
Now, GitHub is a *platform* built around Git. It’s a website where you can store your Git repositories (collections of code and its history) remotely. Think of it like a cloud-based storage space for your code. GitHub makes it super easy to share your code with your team, track progress, and work together on the same project. It's become the standard way developers share and manage their code.
...
[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#glossary)
...
1.  **JIT (Just-In-Time)**: V8, SpiderMonkey: JavaScript engines don't just interpret line by line V8 for example:
    ...
    2.  Profiles hot code paths at runtime
    3.  Compiles hot paths to optimize machine code
    4.  Deoptimize back if assumptions break.
2.  **AOT (Ahead-of-Time)**:
    1.  C++: Source -> machine code (no need runtime, runs natively)
    2.  Java: Source -> bytecode -> JVM interprets or JIT compiles the bytecode at runtime.
3.  Machine Code: it is the language the CPU understands: binary instructions that are architecture specific and map directly to hardware operations. Each instruction corresponds to a circular level operation the processor can execute in one or a few clock cycles. a
    1.  Example `C++: a + b Assembly: ADD EAX, EBX Machine code: 00000011 11000011 (binary) Hex: 03 C3`
4.  Assembly Language: it is just machine code with human-readable mnemonics.

## Core Programming Concepts

[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#core-programming-concepts)

### Data

[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#data)
...
What kind of value (number, string, boolean)
...
[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#logic--flow)
...
[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#organization)
...
Where a variable is visible/accessible

**Namespace**

Grouping to avoid name collisions

**Module**

Self-contained reusable file/unit
...
Defined interface for interacting with code

### Memory

[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#memory)
...
Memory for function calls, automatically managed

**Heap**

Memory for dynamic data, manually or GC managed

**Garbage collection**

Runtime reclaims unused memory automatically

**Pointer/Reference**

Address pointing to a value in memory

### Paradigms

[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#paradigms)
...
Code organized around objects and classes

**Functional**

Code as pure functions, avoid shared state

**Declarative**

Describe *what* not *how* (SQL, HTML)
...
[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#advanced)
...
Don't wait — continue and handle result later

**Callback**

Function passed to run after something completes

**Promise/Future**

Placeholder for a value not yet available
...
[](https://github.com/nelsonlopezjimenez/class-server-resources/blob/main/markdown/lessons/section2-javascript/Intro-To-Javascript.md#data-structures--algorithms)
...
![WWW Highlighted logo.png](https://canvas.corrections.sbctc.edu/courses/392419000000492/files/392419000055645/preview)
...
JavaScript, like HTML5, is written in simple text.  In order to successfully complete the work within these modules, you will need:

-   A text-based HTML / JavaScript / CSS editor

## **Learning Outcomes**

Upon successful completion of this course, students will be able to:

1.  1.  Use object-oriented client-side scripting with well-formed web pages.
    ...
    7.   Distinguish the field of computer science from programming. Including descibing some of the fundementals of computer science such as how data is stored, binary numbers, searching and sorting. 
    8.  Interpret code and determine its output without running it.
    9.  Translate a given algorithm into a working program in a given programming language with output matching a provided specification.
    10.  Given a simple program with errors, apply debugging techniques to find and fix the problems.
    11.  Determine the correct logical construct to use to solve a programming problem.
    12.  Write maintainable code that matches a provided style guide.
    13.  Describe what code does to both technical and non-technical audiences. 
...
-   Watch Colt's Camp Day 1 [here](http://localhost:22022/Public/Videos/RAW-VIDEOS/2022coltsteelebootcamp/Colt's%20Code%20Camp%20Day%201-SF_Xl5TOGlY.mp4)
-   Introduction to JavaScript ppt ch1 [here](https://canvas.corrections.sbctc.edu/courses/392419000000591/files/392419000063665?wrap=1 "JavaScript_Specialist_Slideshow_v2.0.ppt")
-   JavaScript\_Specialist\_Slideshow\_v2.0.ppt [here](https://canvas.corrections.sbctc.edu/courses/392419000000591/files/392419000063665?wrap=1 "JavaScript_Specialist_Slideshow_v2.0.ppt")
-   How Developer [solve problems?.](http://localhost:22022/Public/Downloads/2025/www.theodinproject.com/lessons/foundations-problem-solving.html)
-   Solving [Fizz Buzz.](http://localhost:22022/Public/Downloads/2025/www.theodinproject.com/lessons/foundations-problem-solving.html#solving-fizz-buzz)
-   Read Become top [success story](https://canvas.ed/courses/49921000000094/files/49921000030016?wrap=1 "becoming-top-success-story.pdf") [![](https://canvas.ed/images/svg-icons/svg_icon_download.svg)Download success story](https://canvas.ed/courses/49921000000094/files/49921000030016/download?download_frd=1)
...
-   Try the project [rock-paper-scissors.Links to an external site.](http://localhost:22022/Public/Downloads/2025/www.theodinproject.com/lessons/foundations-rock-paper-scissors.html)

### **DISCUSS**

The following questions are an opportunity to reflect on key topics in this lesson. If you can’t answer a question, click on it to review the material, but keep in mind you are not expected to memorize or master this knowledge.

-   -   -   [What are the three stages in the problem solving process?Links to an external site.](http://localhost:22022/Public/Downloads/2025/www.theodinproject.com/lessons/foundations-problem-solving.html#problem-solving-stages)
        -   [Why is it important to clearly understand the problem first?Links to an external site.](http://localhost:22022/Public/Downloads/2025/www.theodinproject.com/lessons/foundations-problem-solving.html#important-understand-problem)
        -   [What can you do to help get a clearer understanding of the problem?Links to an external site.](http://localhost:22022/Public/Downloads/2025/www.theodinproject.com/lessons/foundations-problem-solving.html#help-understand-problem)
        -   [What are some of the things you should do in the planning stage of the problem solving process?Links to an external site.](http://localhost:22022/Public/Downloads/2025/www.theodinproject.com/lessons/foundations-problem-solving.html#planning-stage)
        -   [What is an algorithm?Links to an external site.](http://localhost:22022/Public/Downloads/2025/www.theodinproject.com/lessons/foundations-problem-solving.html#algorithm)
        -   [What is pseudocode?Links to an external site.](http://localhost:22022/Public/Downloads/2025/www.theodinproject.com/lessons/foundations-problem-solving.html#pseudo)
        -   [What are the advantages of breaking a problem down and solving the smaller problems?Links to an external site.](http://localhost:22022/Public/Downloads/2025/www.theodinproject.com/lessons/foundations-problem-solving.html#breaking-problem)
...
![2026-04-04 17.20.05  7d14dcf6cb28.png](https://canvas.corrections.sbctc.edu/courses/392419000000591/files/392419000064841/preview).
...
HINT: reference [https://www.w3schools.com/jsref/obj\_navigator.asp](https://www.w3schools.com/jsref/obj_navigator.asp)  
and/or [http://localhost:22022/websites/w3schools.com/jsref/obj\_navigator.html](http://localhost:22022/websites/w3schools.com/jsref/obj_navigator.html)
...
.![geolocation button](https://canvas.corrections.sbctc.edu/courses/392419000000591/files/392419000064842/preview)
...
![navigator properties](https://canvas.corrections.sbctc.edu/courses/392419000000591/files/392419000064837/preview)

.![geolocation button
](https://canvas.corrections.sbctc.edu/courses/392419000000591/files/392419000064839/preview)

.![fake geolocation](https://canvas.corrections.sbctc.edu/courses/392419000000591/files/392419000064840/preview)
...
Feel free to type your response by clicking on the "Text Entry" button below. You may also submit your questions as a Google Doc or Microsoft Word document.
...
Purpose
The purpose of this assignment is to learn how to post to a discussion board in Canvas and to create community by engaging with your classmates. 

Task
Please finish the following steps and submit your completed discussion post(s) to Canvas. 

Write your full name
Write the course's full name (see the syllabus)
Make sure you click "subscribe" if necessary.
Part 1: Initial Post

Introduce yourself to your classmates! Feel free to submit a typed response by clicking on the "Reply" button below. Please share...
...
A photo of anything related to your post. You can search your laptop for free images.
Part 2: Response Posts

Once you've written your initial post, read the posts of all of your classmates and reply to two. Make your reply between 3 and 4 sentences long. Connect your response to what your classmate is saying. Also, if you see that some people have replies and others do not, please choose to reply to someone who doesn't yet have a reply.

Criteria for Success
To maximize your opportunity for success, please review the "Discussion Forum Etiquette" guidelines below and check your work before posting. You will need to contribute three meaningful posts: one initial post in response to the prompt and two posts in response to a classmate. Your initial response to the prompt should be at least 150 words in length or approximately 2-minutes of video. Your response posts should be at least 75-words in length or approximately 1-minute of video. They should represent your informed thoughts and ideas and be written in your own words and phrases. If you need to change something in your post after you have submitted it, please see these instructions for editing a post in Canvas. If you add an image, you can caption it by following these instructions for adding alt text to an image  Download  instructions for adding alt text to an imagein Canvas.

Discussion Forum Etiquette
It is important that all students feel safe, respected, valued, and included. Posts should be respectful, and all students are expected to follow the rules of common courtesy in Canvas discussions. When commenting in this discussion board and other forums, please remember that this is a classroom setting and avoid any comments that may be taken out of context. Student conduct according to the Edmonds College student handbook applies in these online discussions. You may find these guidelines helpful: 

Respect the diverse perspectives in our class. Posts should be respectful of diversity including gender, sexuality, disability, age, socioeconomic status, race, religion, and culture. 
Refrain from inappropriate, racist, or negative comments about any individuals in your posts.
Use the face-to-face rule. Don't say anything in an online discussion post or email that you wouldn't say directly to your classmate or instructor in person. 
Be considerate of others’ feelings and use language carefully.
Help to create a safe classroom environment for everyone. 
Use capital letters sparingly: THEY LOOK LIKE SHOUTING.
When quoting or paraphrasing, cite all sources to avoid plagiarism.
Use complete sentences and standard English grammar, spelling, and capitalization to compose posts and proofread your work before submitting it.
Use humor carefully. It’s hard to read the tone of an email or post; sometimes humor can be misread as criticism or personal attack. Feel free to use emojis to let others know you’re being humorous. 😊
...
<head>
<meta charset="UTF-8">
<title>Geolocation Permission Handling</title>
<script>
function requestLocation() {
    ...
    navigator.geolocation.getCurrentPosition(
        ...
        function (position) {
            ...
            // You can redirect to another page if location is granted
        ...
        function (error) {
            switch (error.code) {
                case error.PERMISSION_DENIED:
                    alert("You denied location access. Redirecting...");
                    window.location.href = "denied.html"; // Change to your desired page
                    break;
...
async function checkLocationPermission() {
    if (!navigator.permissions || !navigator.geolocation) {
        alert("Geolocation or Permissions API is not supported by your browser.");
        return;
    }
    ...
    try {
        ...
        if (permissionStatus.state === 'granted') {
            ...
            // Not decided yet — ask for location
            requestLocation();
        } 
        else if (permissionStatus.state === 'denied') {
            // Already denied — redirect or show message
            alert("You have denied location access. Redirecting...");
            window.location.href = "denied.html"; // Change to your page
        }
...
<button onclick="checkLocationPermission()">Check & Request Location</button>
<script>
async function checkLocationPermission() {
    if (!navigator.permissions || !navigator.geolocation) {
        alert("Geolocation or Permissions API is not supported by your browser.");
    ...
    if (status.state === 'denied') {
        ...
        alert("You have denied location access.\n\nPlease enable it in your browser settings:\n" +
              ...
              "- Firefox: Click the lock icon → Permissions → Allow Location\n" +
              "- Safari: Settings → Privacy → Location Services → Enable for this site");
    } else {
        alert("Permission state: " + status.state);
    }
}
</script>
</body>
